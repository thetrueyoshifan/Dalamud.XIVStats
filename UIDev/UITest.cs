...
namespace UIDev
{
    class UITest : IPluginUIMock
    {
        ...
        public void DrawMainWindow()
        {
            ...
            ImGui.SetNextWindowSize(new Vector2(375, 130), ImGuiCond.FirstUseEver);
            ImGui.SetNextWindowSizeConstraints(new Vector2(375, 130), new Vector2(float.MaxValue, float.MaxValue));
            if (ImGui.Begin("TestPlugin", ref this.visible, ImGuiWindowFlags.NoScrollbar | ImGuiWindowFlags.NoScrollWithMouse))
            {
                ImGui.Text("This will show values from the game, if nothing goes wrong");
